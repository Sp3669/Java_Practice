...
public class ArrayAssignment {
	...
	public static void main(String[] args) {
		 ...
		 * Array Assignment
1D Array
Create a String array of 5 student names 
		 */
...
/**
 * 2D Array
Create a 2D array that stores a timetable like:
Monday    - Java      - 2hrs
Tuesday   - Selenium  - 3hrs
Wednesday - Git       - 1hr
Print the full timetable 
*/
...
/**
 * 3D Array
Create a 3D array that stores:
2 batches
3 students each
2 details each (name, score)
 */
System.out.println();
...
for(int batch=0; batch <2; batch++) {
	if(batch==0) {Batch_name = "BharathTech Automation Training batch 1";}
	else{Batch_name = "BharathTech Automation Training batch 2";}
	for(int i=0; i<3; i++) {
				System.out.printf("%s-> name: %s score: %s%n",Batch_name,BharathTechAcademy[batch][i][0],BharathTechAcademy[batch][i][1]);	
		}
	}
 }
}
